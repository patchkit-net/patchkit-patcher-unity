...
namespace PatchKit.Api.Models.Main
{
    public struct App
    {
        ...
        /// <summary>
        /// If set to !false, application needs to contact keys server to get valid key_secret for content download.
        /// </summary>
        ...
        /// <summary>
        /// If set to !false, no PatchKit logo or PatchKit reference should be visible on the patcher.
        /// </summary>
        ...
        /// <summary>
        /// Visible only for the application owner. Set to !false if this application is a channel.
        /// </summary>
