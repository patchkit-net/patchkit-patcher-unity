...
namespace PatchKit.Apps.Updating.Utilities
{
    public static class LauncherUtilities
    {
        private static readonly ILogger Logger = DependencyResolver.Resolve<ILogger>();

        private static readonly IPlatformResolver PlatformResolver = DependencyResolver.Resolve<IPlatformResolver>();
        ...
        public static void ExecuteLauncher()
        {
            try
            {
                ...
                var platformType = PlatformResolver.GetPlatformType();
