...
public static class LauncherUtilities
{
    ...
    private static string FindLauncherExecutable(PlatformType platformType)
    {
        ...
        var defaultLauncherPath = Path.Combine(
            "..",
            GetDefaultLauncherName(platformType));
        ...
        throw new ApplicationException(
            "Failed to find the Launcher executable.");
    }
    ...
    {
        var launcherPath =
            Path.GetFullPath(FindLauncherExecutable(platformType));
